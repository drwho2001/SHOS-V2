...
// Returns { type: "quickAdd", tab, target } | { type: "navigate", tab, subTab } | null.
...
export function resolveDeepLinkRoute(urlString) {
  ...
  // clinic-card, widget/*, and anything unknown: no App-level opener exists
  // (needs new plumbing + a device to verify the tap path) — documented
  // open in CLAUDE.md, not silently guessed at here.
  return null;
}
