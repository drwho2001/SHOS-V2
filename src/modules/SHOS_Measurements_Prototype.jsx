      ...
      <div style={{ background: T.bg, width: "100%", maxHeight: "88vh", display: "flex", flexDirection: "column", borderTopLeftRadius: radius.lg, borderTopRightRadius: radius.lg }} onClick={(e) => e.stopPropagation()}>
        ...
        <div tabIndex={0} style={{ overflowY: "auto", padding: "0 20px", flex: 1 }}>
          ...
          <div style={{ padding: "8px 0 20px" }}>
            ...
            <textarea value={form.note} onChange={(e) => set("note")(e.target.value)} rows={3} aria-label="Notes"
    ...
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ padding: "0 16px 100px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
          ...
          <h1 style={{ ...TYPE.recordTitle, margin: 0, color: T.textPrimary }}>{m.type}</h1>
        </div>
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      {/* FIXED 16 Sep 2026 — real bug: same as Testing/Clinic Visits/
          Vaccinations/Symptom Log's own sticky sub-headings — the
